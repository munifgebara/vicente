...
public class VQueryTest {
    ...
    public void simpleTest() {
        assertEquals("(1 = 1)", vQuery.toStringWithoutParams());
        assertEquals(Boolean.FALSE, vQuery.getUseDistinct());
        assertEquals("", vQuery.getJoinsWithoutParam());
    ...
    public void constructorLogicalOperatorCriteriaSubQuerys1() {
        ...
        assertEquals("(cpf = '000.000.000-00') AND ((1 = 1))", vQuery.toStringWithoutParams());
    }
    ...
    public void constructorLogicalOperatorCriteria3() {
        ...
        assertEquals("((nome = 'Willian') AND ((idade > 80)) OR (sexo = 'MASCULINO'))", vQuery.toStringWithoutParams());
    }
    ...
    public void constructorCriteria2() {
        ...
        assertEquals("(((nome = 'Willian') AND (idade > 80)) OR (sexo = 'MASCULINO') OR (sexo = 'FEMININO') OR (sexo = 'OUTRO') OR (sexo = 'TESTE'))", vQuery.toStringWithoutParams());
    }
    ...
    public void constructorCriteria3() {
        vQuery = new VQuery(new Criteria("nome", ComparisonOperator.EQUAL, "Willian"))
                ...
                .or(new Criteria("sexo", ComparisonOperator.EQUAL, "OUTRO"))
                .or(new Criteria("sexo", ComparisonOperator.EQUAL, "TESTE"));
        assertEquals("(((nome = 'Willian') AND (idade > 80) AND (idade < 70)) OR (sexo = 'MASCULINO') OR (sexo = 'FEMININO') OR (sexo = 'OUTRO') OR (sexo = 'TESTE'))", vQuery.toStringWithoutParams());
    }
    ...
    public void testJoin1() {
        ...
        assertEquals("(nome = 'willian')", vQuery.toStringWithoutParams());
        assertEquals(" inner join Endereco on pessoa.id = id", vQuery.getJoinsWithoutParam());
    }
    ...
    public void testJoin2() {
        ...
        assertEquals(" inner join Endereco on pessoa.id = id left join Telefone", vQuery.getJoinsWithoutParam());
    }
    ...
    public void testJoin3() {
        ...
        assertEquals(" inner join Endereco on pessoa.id = id left join Telefone join Historico on id = id and descricao like '%teste%'", vQuery.getJoinsWithoutParam());
    }
    ...
    public void testJoin4() {
        ...
        assertEquals(" inner join Endereco on pessoa.id = id left join Telefone join Historico on id = id and descricao like '%teste%' join Historico on id = id and descricao like '%teste%' or descricao like '%willinha%'", vQuery.getJoinsWithoutParam());
    }
    ...
    public void in() {
        ...
        assertEquals("(((sexo in ('M','F')) AND (idade in (1,2,3))) OR (elementos in (ola,teste)))", vQuery.toStringWithoutParams());
    }
    ...
    public void between() {
        ...
        assertEquals("((idade between 1 and 2) OR (nome between 'a' and 'c'))", vQuery.toStringWithoutParams());
    }
    ...
    public void testDate() {
        vQuery = new VQuery(new Criteria("dataCadastro", ComparisonOperator.BETWEEN, new Date[]{new Date(1518291786286l), new Date(1519299799286l)}))
                .or(new Criteria("nome", ComparisonOperator.BETWEEN, new String[]{"a", "c"}));
        assertEquals("((dataCadastro between '2018/02/10 17:43:06' and '2018/02/22 08:43:19') OR (nome between 'a' and 'c'))", vQuery.toStringWithoutParams());
    }

    @Test
    public void testVEntityQuery() {
        vQuery = new VEntityQuery(Aluno.class, new Criteria("nome", ComparisonOperator.CONTAINS, "Willian"));
        assertEquals("(select obj from Aluno obj where (nome like '%Willian%'))", vQuery.toStringWithoutParams());
    }
    ...
    public void testEMPTY() {
        ...
        assertEquals("(1 = 1)", gQuery.toStringWithoutParams());
    }

    @Test
    public void testSIMPLE() {
        VQuery gQuery = new VQuery(new Criteria("name", ComparisonOperator.EQUAL, "munif"));
        assertEquals("(name = 'munif')", gQuery.toStringWithoutParams());
    }
    ...
    public void testAND() {
        ...
        assertEquals("((name like 'munif%') AND (age >= '18') AND (name like '%gebara%'))", gQuery.toStringWithoutParams());
    }
    ...
    public void testOR() {
        ...
        assertEquals("((name like 'munif%') OR (name like 'vicente%') OR (name like 'duda%'))", gQuery.toStringWithoutParams());
    }
    ...
    public void testFluent2() {
        ...
        assertEquals("((name like 'munif%') OR (name like 'vicente%') OR (name like 'duda%') OR (name like '%gebara%'))", gQuery.toStringWithoutParams());
    }
